...
<body>    
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-custom-heading">
                        <h3 class="panel-custom-title" align="center">Trial Drive Admin</h3>
                    </div>
          ...
          <div style="text-align: center; position: relative;"><label style="font: italic 40px serif !important; " >Trial Drive, Delivery has never been faster!</label></div>
    <div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    </div>  
          <div style="text-align: center; position: relative;"><label style="font: italic 20px serif !important; " >Contact Email :   support@trialdrive.com</label></div>
    <div>
</body>
