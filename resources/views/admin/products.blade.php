                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>   
                                                @if($warehouse_id)
                                                  <div class="col-md-1" style="width:20px;padding-left: 0px;padding-right: 0px"><a href="{{asset('admin/product_edit')}}/{{$product->product}}/{{$warehouse_id}}"><i class=" fa fa-edit"></i></a></div>
                                                @else
                                                  <div class="col-md-1" style="width:20px;padding-left: 0px;padding-right: 0px"><a href="{{asset('admin/product_edit')}}/{{$product->product}}"><i class=" fa fa-edit"></i></a></div>
                                                @endif
