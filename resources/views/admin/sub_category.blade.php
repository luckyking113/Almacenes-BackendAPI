  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="col-md-8">
            ...
            <label style="font-size: 22px">{{$parent->name}}'s: Subcategorias</label>
     
       </div>
            <div class="col-md-2" style="text-align: right">
           <a href="{{asset('admin/add_category')}}/{{$parent->category_id}}" class="btn btn-default"> Crear Subcategoria</a>
       </div>
       </div>
      <ol class="breadcrumb">
        <li><a href="{{asset('admin/dashboard')}}"><i class="fa fa-dashboard"></i> Categorias</a></li>
...
//                                                    else
                                            ...
                                            <td>
                                             ...
                                             <div class="col-md-1" style="width:20px;padding-left: 5px;padding-right: 0px"><a href="{{asset('admin/product_list_cat')}}/{{$category->category_id}}" title="View sub category"><i class="fa fa-list"></i></a></div>
                                                </td>
                                        </tr>
                                    @endforeach
                                </tbody>
