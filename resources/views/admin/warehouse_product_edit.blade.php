    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <form id="productForm" method="POST" action='{{asset('admin/post_edit_product')}}' enctype="multipart/form-data" onsubmit="return checkvalidity(this);" >
                                     {{ csrf_field() }}
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input id="name" name="name" type="text" value="{{$product->name}}" placeholder="Product Name" class="form-control required" />
                </div>
...
<!--                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="exampleInputPassword1">Primary Image(Square)</label>  <br/>
                  ...
                  <div class="form-group">
                  <label for="exampleInputPassword1">Product Detail Images</label>
                  <div class="row">
