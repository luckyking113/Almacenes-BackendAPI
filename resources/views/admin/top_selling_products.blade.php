  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="col-md-8">
            ...
            <label style="font-size: 22px">Top 100 Productos Mas Vendidos</label>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Top 100 Productos Mas Vendidos</li>
      </ol>
         ...
         function filterProduct(obj)
                                            {
                                                ...
                                                window.location.href = "<?php echo asset('admin/top_product_list'); ?>/" + warehouse ;
                                            }
  $(function () {
    $('#table').DataTable()
    $('#example2').DataTable({
