  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="col-md-8">
           ...
           <a href="{{asset('admin/add_warehouse_user')}}" class="btn btn-default"> Crear Empleado</a>
       </div>
       </div>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
           ...
           <div class="form-group">
                  ...
                  <select id="time_shift" name="time_shift" class="form-control" onchange="filterUser(this)" />
                   <option value=''>Selecionar un Turno</option>
                                    ...
                                    @foreach ($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <div class="col-md-1" style="width:20px;padding-left: 5px;padding-right: 0px"><a href="{{asset('admin/paydays')}}/{{$user->id}}" ><i class="fa fa-list"></i></a></div>
                                             <div class="col-md-1" style="width:20px;padding-left: 5px;padding-right: 0px"><a href="{{asset('admin/user_orders')}}/{{$user->user_type}}/{{$user->id}}" title="View Orders"><i class="fa fa-eye"></i></a></div>  
                                             </td>
                                        </tr>
                                    @endforeach
                                </tbody>
     ...
     <script>
         ...
         function filterUser(obj)
         {
            ...
            if(time_shift == '' && day == '')
            {
             ...
             window.location.href="<?php echo asset('admin/employee_list');?>/"+warehouse+'/'+time_shift+'/'+day+'/'+user_type;
         }
  $(function () {
    $('#table').DataTable()
    $('#example2').DataTable({
