  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="col-md-8">
            ...
            <label style="font-size: 22px">Historial de Registro</label>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Historial de Registro</li>
      </ol>
                                ...
                                <tbody>
                                    @foreach ($logs as $log)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$log->quantity}}</td>
                                            <td>@if(isset($log->product)){{$log->product->quantity->quantity}} @endif</td>
                                            <td>${{$log->price}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
