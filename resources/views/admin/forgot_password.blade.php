...
<div class="login-box ">
  ...
  <div class="login-box-body " style="background-color:#ddddff">
    ...
    <form action="{{asset('admin/submit_forgot_password')}}" method="post">
         {{ csrf_field() }}
      <div class="form-group has-feedback">
          <input type="email" class="form-control" placeholder="Escribir Correo" name="email" id="email" required="">
