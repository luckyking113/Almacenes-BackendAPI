...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Vista General de Almacen
        <small>Panel de Control</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Inicio</a></li>
        <li class="active">Vista General de Almacen</li>
      </ol>
    </section>
...
<div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">@if(isset($selected_warehouse_name->name)) {{$selected_warehouse_name->name}} @else Capacidad @endif de Almacenes</h3>
